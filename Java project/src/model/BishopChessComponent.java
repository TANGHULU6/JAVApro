    ...
    public boolean canMoveTo(ChessComponent[][] chessComponents, ChessboardPoint destination) {
        ...
        if (destination.getX()-source.getX()==destination.getY()-source.getY()) {
            ...
            for (int col = Math.min(source.getY(), destination.getY()) + 1;
                ...
                if (!(chessComponents[row+col-(Math.min(source.getY(), destination.getY()))][col] instanceof EmptySlotComponent)) {
                    return false;
                }
            }
            ...
            for (int row = Math.min(source.getX(), destination.getX()) + 1;
                ...
                if (!(chessComponents[row][col+row-(Math.min(source.getX(), destination.getX()))] instanceof EmptySlotComponent)) {
                    return false;
                }
            }
